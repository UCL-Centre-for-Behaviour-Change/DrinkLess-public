...
#import "PXReviewAuditViewController.h"
#import "PXTabView.h"
...
@interface PXReviewAuditViewController ()
...
@implementation PXReviewAuditViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    self.screenName = @"PX Review audit";
...
- (UIViewController *)instantiateViewControllerForTab:(PXTab)tab {
    ...
    if (tab == PXTabAnswers) {
        viewController = [ReviewAuditTableViewController reviewAuditViewController];
    }
