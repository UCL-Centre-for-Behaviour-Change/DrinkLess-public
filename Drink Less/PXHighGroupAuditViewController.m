...
- (NSMutableArray *)viewControllers {
    if (!_viewControllers) {
        ...
        for (NSUInteger i = 0; i < count; i++) {
            ...
            infographicViewController.populationType = (i < 2) ? PXPopulationTypeCountry : PXPopulationTypeAgeGender;
            infographicViewController.auditCalculator = self.auditCalculator;
...
- (void)setViewingLastPage:(BOOL)viewingLastPage {
    NSString *title = viewingLastPage ? @"Continue" : @"Next";
